...
const renderFile = (file) => {
  ...
  const isPDF =
    file.includes("/raw/") || file.toLowerCase().includes(".pdf");
...
//   if (isPDF) {
//     return (
//       <a href={file.replace("/upload/", "/upload/fl_inline/")} 
//       target="_blank"
...
//   if (isPDF) {
//     // 🔥 FORCE DOWNLOAD/VIEW FIX
//     const fixedUrl = file.replace("/upload/", "/upload/fl_attachment/");
        ...
        <div className="admin-grid">
          ...
          {app.lgaCertificate && (
            <div className="doc-item">
              ...
              <p>
                <a href={`/verify/${app.verificationCode}`} target="_blank">
                  🔍 Verify Record
                </a>
              </p>
...
//           <a href={app.admissionLetter} target="_blank"
//           rel="noopener noreferrer"
//           >View PDF</a>
